(function () {
  ...
  var browserInfo = (function () {
    ...
    var chromeVersion = 0;
    var edgeVersion = 0;
    if (/(chrome|edge)\D+(\d[\d.]*)/.test(lcUserAgent)) {
      var key = RegExp.$1;
  ...
  var appCode = browserInfo.appCode;
  var appVersion = browserInfo.appVersion;
  var kernelCode = browserInfo.kernelCode;
  var kernelVersion = browserInfo.kernelVersion;
